...
public class Flights {
    ...
    public Flights(String name, String departTime, String departDate, String arrivalTime, String arriveDate){
        this.NAME = new SimpleStringProperty(name);
        this.DEPARTTIME = new SimpleStringProperty(departTime);
        this.DEPARTDATE = new SimpleStringProperty(departDate);
        this.ARRIVALTIME = new SimpleStringProperty(arrivalTime);
        this.ARRIVALDATE = new SimpleStringProperty(arriveDate);
    }
